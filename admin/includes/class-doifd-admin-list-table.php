...
class DOIFDAdminListTable extends DOIFDAdmin {
    ...
    public function get_data() {
        ...
        $sql = "SELECT * FROM " . $wpdb->prefix . "doifd_lab_downloads WHERE doifd_download_type = '1' LIMIT $offset, $this->display_limit ";
    ...
    public function get_columns() {
        ...
        $columns = array(
            'doifd_download_name' => __ ( 'List Name', $this->plugin_slug ),
    ...
    public function prepare_rows() {
        ...
        if ( ! empty ( $this->data ) ) {
            ...
            foreach ( $this->data as $key => $value ) {
                ...
                $row .= '<td width="25%" class="column-columnname">' . $this->column_doifd_landing_page ( $value ) . '</td>';
            ...
            $row = '<td colspan="6" align="center">No Lists Yet</td>';
        }
