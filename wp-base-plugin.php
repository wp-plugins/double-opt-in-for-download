...
if (!class_exists('WPBasePlugin')) {
    abstract class WPBasePlugin {
        ...
        function WPBasePlugin($options_name) {
            $args = func_get_args();
            call_user_func_array(array(&$this, "__construct"), $args);
        }
        
        function __construct($options_name) {
            $this->environment = WPBasePlugin::determine_environment();
            $this->options_name = $options_name;
            
            $this->options = WPBasePlugin::retrieve_options($this->options_name);
        }
        ...
        static function plugins_directory() {
            if (WPBasePlugin::determine_environment() == Environment::WordPressMU)
        ...
        static function path_to_plugin_directory() {
            ...
            return WPBasePlugin::plugins_directory() . "/${current_directory}";
        }
        
        static function url_to_plugin_directory() {
           $current_directory = basename(dirname(__FILE__));
           
           return WPBasePlugin::plugins_url() . "/${current_directory}";
        }
        ...
        static function path_to_plugin($file_path) {
            ...
            if (WPBasePlugin::determine_environment() == Environment::WordPressMU)
                return WPBasePlugin::plugins_directory() . "/${file_name}";
            else
                return WPBasePlugin::path_to_plugin_directory() . "/${file_name}";
        }
